  ...
  return (
    <div className="contact-page">  {/* Main container for the contact page */}
      ...
      <form className="contact-form">  {/* Form for user input */}
        ...
        <div className="form-group">  {/* Container for message input */}
          <label htmlFor="message">Message</label>
          <textarea id="message" name="message" placeholder="Your message" rows="5" required></textarea>
        </div>
        
        <button type="submit" className="submit-btn">Send Message</button>  {/* Submit button for the form */}
      </form>
