...
function FavoriteList({ favorites, onRemoveFavorite, onClearFavorites }) {  // Added onClearFavorites prop
    ...
    return (
        ...
        <button  className="clear-all-button" onClick={onClearFavorites}>Clear All</button> {/* Button to clear all favorites */}
        </div>
    );
}
